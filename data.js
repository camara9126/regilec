    ...
    function downloadInvoicePDF() {
      ...
      // Appliquer des styles optimisés pour le PDF mobile
...
${topProducts || 'Aucune donnée'}
    ...
    function updateStock() {
      ...
      // Si c'est un nouveau produit (pas d'ID)
      if (!productId) {
        addNewStock();
        return;
      }
    ...
    function addClient(event) {
      ...
      // Mettre à jour le select des clients dans le modal de facture
      const clientSelect = document.getElementById('invoiceClient');
      if (clientSelect) {
    ...
    function generatePayslipForPayment(paymentId) {
      ...
      // Construire le contenu HTML du bulletin de salaire
      const payslipHTML = `
        <div class="invoice-pdf-mobile">
          <div class="invoice-header-mobile">
            <div class="company-info-mobile">
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      // Initialiser les écouteurs pour le client select
